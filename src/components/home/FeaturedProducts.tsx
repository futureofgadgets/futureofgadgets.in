        ...
        <div className="mx-auto max-w-[1440px]  sm:px-6 lg:px-11">
          <div className="flex items-center justify-between mb-4 sm:mb-6 px-3 sm:px-0">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-0.5 sm:mt-1">Handpicked favorites for you</p>
            </div>
            <Link href="/products" className="text-blue-600 hover:text-blue-700 font-semibold text-xs sm:text-sm whitespace-nowrap hover:underline">View All →</Link>
          </div>
